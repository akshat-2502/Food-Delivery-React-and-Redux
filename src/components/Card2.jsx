...
const Card2 = ({ foodItem }) => {
  ...
  return (
    <div className={`${darkMode ? "dark" : ""}`}>
      <div className="w-full h-[120px] border-2 border-green-500 rounded-lg shadow-md transition-all duration-700 dark:bg-zinc-950 bg-zinc-100 flex mb-2">
        <div className="w-[80%] h-full  p-2 flex gap-2">
          ...
          <div className="w-[40%] h-full flex flex-col items-center gap-3">
            <div className="md:font-semibold text-[15px] dark:text-zinc-100">
              {foodItem.name}
            </div>
